...
class Summary():
    ...
    def generate_summary(self):
        ...
        filing_date = compliance['form_filing_date'].split()[0] if compliance['form_filing_date'] != 'Not specified' else 'Not specified'

        # Handle compliance sections safely
        compliance_section = context['compliance_sections'][0] if context['compliance_sections'] else "Companies Act, 2013"
        ...
        summary = (
            ...
            f"{compliance_section}, with the form filed on "
...
def start():
    """Batch processing function for command line usage"""
